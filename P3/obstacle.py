...
def VFF_controller(laser, goal):
    ...
    for i in range(len(laser)):
        ...
        if(i>len(laser)*0.3 and i<len(laser)*0.7):
            obstacle_force[0]=obstacle_force[0]+laser[i][0]/sqr_dist*obstacle_k*front_k
            obstacle_force[1]=obstacle_force[1]+laser[i][1]/sqr_dist*obstacle_k*front_k
        else:
